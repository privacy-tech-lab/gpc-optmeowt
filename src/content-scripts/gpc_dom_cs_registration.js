...
/*
gpc_dom_cs_registration.js
================================================================================
gpc_dom_cs_registration.js is the content script, registered via the 
...
const INJECTION_SCRIPT = 'gpc_dom_cs_injection.bundle.js'
...
chrome.storage.local.get(null, function(res){
  console.log("chrome.storage.local =>", res);
})

chrome.storage.local.get([domain], function(res) {
  console.log(`RETRIEVED ${JSON.stringify(res)} from ${domain}`);
  console.log("typeof res[domain]", typeof res[domain]);
  if (res !== null && typeof(res[domain]) !== "number") {
    injectStaticScript();
  }
});

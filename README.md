...
OptMeowt is developed and maintained by Ruby Friedman (@RubyFri), Kyle Quintana (@KyleQ-hub) and Sebastian Zimmeck (@SebastianZimmeck) of the [privacy-tech-lab](https://privacytechlab.org/).
...
- Sebastian Zimmeck, [Remarks on the Relevance of Privacy Expectations for Default Opt-out Settings](https://sebastianzimmeck.de/zimmeckRemarks2026.pdf), IEEE Symposium on Privacy Expectations (ISoPE), New York, New York, October 2025, [BibTeX](https://sebastianzimmeck.de/citations.html#zimmeckGPCRemarks2026Bibtex)
...
- Sebastian Zimmeck, [Beyond the Checkbox: Upgrading the Right to Opt Out](https://doi.org/10.1145/3727636), Communications of the ACM, Vol. 68, No. 7, 23-25, July 2025

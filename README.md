...
OptMeowt is developed and maintained by Oliver Wang (@OliverWang13), Sophie E (@sophieeng), Jocelyn Wang (@Jocelyn0830), Kate Hausladen (@katehausladen), and Sebastian Zimmeck (@SebastianZimmeck) of the [privacy-tech-lab](https://privacytechlab.org/). Kuba Alicki (@kalicki1), Stanley Markman (@stanleymarkman), Kiryl Beliauski (@kbeliauski), Daniel Knopf (@dknopf), and Abdallah Salia (@asalia-1) contributed earlier. Learn more [here](https://privacytechlab.org/).
